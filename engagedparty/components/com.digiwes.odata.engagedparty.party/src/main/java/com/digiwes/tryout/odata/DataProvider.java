...
public class DataProvider {
  ...
  public DataProvider() {
    ...
    data.put(PartyEdmProvider.ES_INDIVIDUAL_NAME, createCars());
    data.put(PartyEdmProvider.ES_PARTY_NAME, createManufacturers());
  }
  ...
  private EntityCollection createCars() {
    ...
    for (Entity entity:entitySet.getEntities()) {
      entity.setType(PartyEdmProvider.ET_INDIVIDUAL.getFullQualifiedNameAsString());
    }
    return entitySet;
  }
  ...
  private EntityCollection createManufacturers() {
    ...
    for (Entity entity:entitySet.getEntities()) {
      entity.setType(PartyEdmProvider.ET_PARTY.getFullQualifiedNameAsString());
    }
    return entitySet;
  }
